...
"""
TensorRT engine builder for MixFormerV2 ONNX models.

Quick usage examples:
    python converter/engine_builder.py
    python converter/engine_builder.py --onnx output/onnx/mixformerv2.onnx --engine output/mixformerv2_fp16.engine --fp16
    python converter/engine_builder.py --onnx output/onnx/mixformerv2.onnx --engine output/mixformerv2_fp32.engine --no-fp16 --workspace-gb 2.0

Notes:
- Run this script from the MixFormerV2 root directory for default relative paths.
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--onnx",
        type=Path,
        default=Path("output/onnx/mixformerv2.onnx"),
        help="Path to the ONNX model file.",
    )
    parser.add_argument(
        "--engine",
        type=Path,
        default=Path("output/mixformerv2_fp16.engine"),
